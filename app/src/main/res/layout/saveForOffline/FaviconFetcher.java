...
public class FaviconFetcher {
	private static jonas.tool.saveForOffline.FaviconFetcher INSTANCE = new jonas.tool.saveForOffline.FaviconFetcher();
	...
	public static jonas.tool.saveForOffline.FaviconFetcher getInstance () {
		return INSTANCE;
	}
