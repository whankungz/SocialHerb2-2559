...
public class ScreenshotService extends Service {
	...
	private final class ServiceHandler extends Handler {
		...
		public void handleMessage(final Message msg) {
			...
			webview = new WebView(jonas.tool.saveForOffline.ScreenshotService.this);
			Log.i(TAG, "Creating WebView");

			//without this toast message, screenshot will be blank, dont ask me why...
			Toast.makeText(jonas.tool.saveForOffline.ScreenshotService.this, "Save completed.", Toast.LENGTH_SHORT).show();
			...
			boolean javaScriptEnabled  = PreferenceManager.getDefaultSharedPreferences(jonas.tool.saveForOffline.ScreenshotService.this).getBoolean("enable_javascript", true);
			webview.getSettings().setJavaScriptEnabled(javaScriptEnabled);

			webview.getSettings().setAllowFileAccessFromFileURLs(true);
			webview.getSettings().setAllowUniversalAccessFromFileURLs(true);

			webview.loadUrl(intent.getStringExtra(jonas.tool.saveForOffline.Database.FILE_LOCATION));
			Log.i(TAG, "Loading URL: " + intent.getStringExtra(jonas.tool.saveForOffline.Database.FILE_LOCATION));
			...
			webview.setWebViewClient(new WebViewClient() {
					...
					public void onPageFinished(WebView view, String url) {
						...
						takeWebviewScreenshot(intent.getStringExtra(jonas.tool.saveForOffline.Database.THUMBNAIL));
