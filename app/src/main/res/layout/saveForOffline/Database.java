...
public class Database extends SQLiteOpenHelper {
	...
	public void addToDatabase(String destinationDirectory, String pageTitle, String originalUrl) {
		...
		values.put(jonas.tool.saveForOffline.Database.FILE_LOCATION, destinationDirectory + "index.html");
		values.put(jonas.tool.saveForOffline.Database.SAVED_PAGE_BASE_DIRECTORY, destinationDirectory);
		values.put(jonas.tool.saveForOffline.Database.TITLE, pageTitle);
		values.put(jonas.tool.saveForOffline.Database.THUMBNAIL, destinationDirectory + "saveForOffline_thumbnail.png");
		values.put(jonas.tool.saveForOffline.Database.ORIGINAL_URL, originalUrl);

		dataBase.insert(jonas.tool.saveForOffline.Database.TABLE_NAME, null, values);
